...
% Fs: samplerate
% tspike: spike times
% rawfolder and raw_file: paths to load the raw data
%
% Outputs
% mean_wave_filt: average filtered waveform (not upsampled)
% twave: timestamps for mean_wave_filt
% mean_wave_upsample: upsampled filtered waveform (used for increased
% precision in getSpikeWidth)
% Fs_upsample: samplerate after upsampling
% twave_upsample: timestamps for mean_wave_upsample
